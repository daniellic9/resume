...
\cvitem{Good}{Java, Django, \LaTeX, ARM Assembly, Digital Circuits, HTML, CSS, VHDL, Docker, Jenkins, Ansible}
\cvitem{Intermediate}{Python, C/C++, Shell Script, Git, GNU/Linux Operational Systems, Lisp, Haskell}
\end{document}
