...
{
    \begin{itemize}
	    \item Contributed to aks-engine, a open source Go project that Azure uses to deploy its managed kubernetes service (AKS).
	    \item Created the official mariaDB Terraform module, using the best practices like infrastructure testing with terratest.
        \item Designed and implemented a notification system in Go for one of the biggest e-commerces in LATAM.
        \item Created a QnA Maker SDK for Java, alongside two more engineers.
        \item Mentored five Cloud Solution Architects on infrastructure subjects subjects.
    \end{itemize}
}
...
\cvitem{Intermediate}{C\#, Java, \LaTeX, HTML, CSS, Docker, Ansible, Angular, Kubernetes, Terraform}
\cvitem{Good}{Python, C/C++, Go, Shell Script, Git, GNU/Linux Operational Systems, Lisp, Azure}
\end{document}
