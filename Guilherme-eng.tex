...
\cventry{2016 -- Present}{Undergraduate Research}{Unicamp}{Campinas}{Brasil}
{
    ...
    Built a Continuous Integration System with Docker and Jenkins.
    Skills: GNU/Linux Systems, C/C++, Shell Script, Python, Docker and Jenkins.\\ 
...
\cvitemwithcomment{Básic}{Spanish}{}

\section{Technical Skills}

\cvitemwithcomment{}{C/C++, Java, Python, Django, Shell Script, Git, \LaTeX, GNU/Linux Systems, \\Data Structures, Arduino, ARM Assembly,
                    Digital Circuits, HTML, CSS, \\Ruby, Rails, VHDL, Docker, Jenkins.}{}
