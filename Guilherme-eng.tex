...
\cventry{2017 -- Present}{Data Science Intern}{CETAX}{São Paulo}{Brasil}
{
    Development of big data and data science applications, writing API's to obtain data and
    creating Machine Learning models. 
    Helped the implementation of code culture.\\
    Skills: Python, Spark and GNU/Linux Systems.
}

\subsection{Academic}
\cventry{2016 -- 2017}{Undergraduate Research}{Unicamp}{Campinas}{Brasil}
{
...
\cventry{2017 -- Present}{Member}{LivreCamp - Unicamp}{Campinas}{Brasil}
{
    LivreCamp member, free knowledge and software group from Unicamp. I worked as assistant and teacher on Shell Script
    and GNU/Linux courses.
}
