...
{
    Desenvolvimento de aplicações pra diferentes áreas, além de cuidar da infraestrutura e escrever textos e tutoriais sobre o que foi 
    feito.\\ 
...
\cvitem{Básico}{Java, Django, \LaTeX, ARM Assembly, Circuitos Digitais, HTML, CSS, VHDL, Docker, Jenkins, Ansible}
\cvitem{Intermediário}{Git, Sistemas Operacionais GNU/Linux, Shell Script, Lisp, Haskell}
\cvitem{Avançado}{Python, C/C++}
