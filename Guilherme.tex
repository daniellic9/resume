...
{
    Trabalho com processamento de dados sísmicos em arquiteturas Power (IBM), visando otimizar tal tarefa. Experiência com código
    para GPUs e computação de alto desempenho (CUDA e OpenCL). Atualmente também desenvolvendo um sistema de Integração Contínua 
    feito com Docker e Jenkins.\\
    Competências envolvidas: Sistemas GNU/Linux, C/C++, Shell Script, Python e Docker.\\ 
...
\cvitemwithcomment{}{C/C++, Java, Python, Django, Shell Script, Git, \LaTeX, Sistemas GNU/Linux, \\Estruturas de Dados, Arduino, ARM Assembly,
                    Circuitos Digitais, HTML, CSS, \\Ruby, Rails, VHDL, Docker, Jenkins.}{}
