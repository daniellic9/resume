...
{
    Desenvolvimento de aplicações envolvendo ciência de dados e big data.\\
...
\cvitem{Intermediário}{Java, Django, \LaTeX, HTML, CSS, Docker, Jenkins, Ansible, SQL, Hadoop, Spark}
