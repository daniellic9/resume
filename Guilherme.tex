...
{
    \begin{itemize}
        \item Desenvolveu código Back-End em Python com ASP.NET.
        \item Desenvolveu código Front-End com Angular.
        \item Cuidou de infraestrutura como código com Kubernetes, Docker e Terraform.
        \item Planejou e implementou arquiteturas distribuídas de Nuvem com Azure.
    \end{itemize}
    Competências envolvidas: Python, C\#, Angular, Azure, Docker, Terraform, Kubernetes.
}
...
\cventry{2016 -- 2017}{Iniciação Científica}{IBM - Unicamp}{Campinas}{Brasil}
{
    \begin{itemize}
        ...
        \item Desenvolveu o \href{https://github.com/Guilhermeslucas/OpenCL2CUDA}{OpenCL2CUDA}, responsável pela conversão inicial entre as bibliotecas OpenCL e CUDA.
...
\cvitem{Bom}{Python, C/C++, Git, Sistemas Operacionais GNU/Linux, Shell Script, Lisp}
