...
\cventry{2016 -- Presente}{Iniciação Científica}{Unicamp}{Campinas}{Brasil}
{
    ...
    para GPUs e computação de alto desempenho. Atualmente também administrando um sistema de Integração Contínua feito com Docker e Jenkins.\\
...
\cvitemwithcomment{}{C/C++, Java, Python, Django, Shell Script, Git, \LaTeX, Sistemas GNU/Linux, \\Estruturas de Dados, Arduino, ARM Assembly,
                    Circuitos Digitais, HTML, CSS, \\Ruby, Rails, VHDL, Docker.}{}
